          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            ...
            <div>
              ...
              <select
                ...
                data-tooltip-content="Seleccione la región apropiada para su aplicación"
              >
                <option value="">Seleccione una región</option>
                <option value="eu1.cloud.thethings.network">Europa 1</option>
                <option value="nam1.cloud.thethings.network">
                  América del Norte 1
                </option>
                <option value="au1.cloud.thethings.network">Australia 1</option>
              </select>
              <Tooltip id="tooltip-region" />
            </div>
          </div>
          <button
            type="submit"
